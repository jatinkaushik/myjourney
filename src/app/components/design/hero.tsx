export default function Hero() {
  return (
    <div className="grid grid-cols-12 justify-center">
      <div className="col-span-12 md:col-span-4 pb-8 px-8 order-1 md:order-2">
        <div className="relative w-full h-full">
            ...
            <div className="relative w-full h-full">
                ...
                alt="Hero Image"
                className="rounded-4xl shadow-lg lg:block hidden"
                />
            </div>
        </div>
      </div>
      <div className="col-span-12 lg:col-span-8 order-2 md:order-1 text-[1.2rem] lg:text-[2.5rem] font-medium">
      ...
      <div className="col-span-12 text-[1.2rem] font-light order-3 text-muted-foreground">
