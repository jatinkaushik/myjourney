...
const ExperienceCard = (exp:ExperienceCardProps) => {
    return (
        <div className="flex flex-col lg:flex-row w-full shadow-lg rounded-3xl gap-2 items-top bg-background px-5 py-2 lg:px-10 lg:py-5">
            <div className="order-1 lg:order-1 font-semibold text-primary-foreground items-start justify-start">
                ...
                <div className="flex flex-col item-start justify-start text-sm font-normal text-primary-foreground">
                    <div>
                        {exp.duration}
                    </div>
                    <div>
            ...
            <div className="flex flex-1 flex-col order-2 lg:order-2 mb-4 text-sm lg:text-lg text-muted-foreground min-h-30 justify-center px-0 lg:px-20">
